...
<details>
  ...
  **Requirements**: Make sure you have the following requirements:
  ...
  - VASProcar **<a href="https://pypi.org/project/vasprocar/">link</a>**
    ...
    **VASProcar** <img src="etc/figures/VASProcar_logo.png" alt="Descrição" style="vertical-align:middle; width: 30px;"> is one of **SAMBA**'s <img src="etc/figures/SAMBA_logo.png" alt="Descrição" style="vertical-align:middle; width: 30px;"> main packages, which handles the post-processing and plotting of results from **VASP** <img src="etc/figures/VASP_logo.png" alt="Descrição" style="vertical-align:middle; width: 30px;"> output files.
