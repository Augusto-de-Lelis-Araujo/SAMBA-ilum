...
separation_2 = 3.0                     # Separation distance (in Angs.) between the 2nd and 3rd material.
...
- **crit_angle_diff** Define a tolerância absoluta (em graus) da diferença angular, entre as duas redes. É uma critério complementar ao **crit_angle_perc**,
