...
# Simulation and Automated Methods for Bi/Trilayer Analysis<br>
...
## +1.100 Bilayers underwent Structural Optimization and Electronic Structure calculations
...
Subsequently, SAMBA also allowed for high-throughput structural relaxation and electronic property calculations for more than **1100** of these bilayers, a number that continues to grow.
...
<details>
  ...
  To customize the DFT calculations, run the SAMBA code (**python -m samba_ilum**) in your working directory and select **option [6]**.
