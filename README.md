...
collecting information from all the DFT calculations performed, and another storing the structural metadata of over 18,000 bilayers generated by the SAMBA code. These files are available in the folder **Twisted_2D_vdW_Bilayers_database**.
